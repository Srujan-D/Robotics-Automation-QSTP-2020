...
class TurtleBot:
    ...
    def __init__(self, current_time=None):
        ...
        self.n_points = 0                       # number of points in the path
        self.n = points()
        self.n.x = [0.0]
        self.n.y = [0.0]
        self.n.z = [0.0]
    ...
    def move2goal(self, current_time=None):     # Function that commonds the turtlebot
        ...
        while not rospy.is_shutdown(): 
            ...
            while(((self.dist(self.new_y, self.new_x)) > 0.1) and (i < self.n_points)): #and (self.error > 0)  ):
                ...
                if ((self.flag == True) and (self.dist(self.new_y, self.new_x) > 0.1)):   # Precision is 0.1
                    print("Translating")
                    if (i == 0):
                    ...
                    print(self.SetPoint)
                    self.feedback_value = self.dist(self.new_y, self.new_x)
                    rospy.loginfo(self.feedback_value)
